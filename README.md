...
This component utilises the opensource IONOS Webhook for Core DNS and Let's Encrypt originally written by fabmade.de.  I have complied this and stored the built container image in my public DockerHub repository.
