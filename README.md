...
A scripted Cert-Manager & IONOS Core DNS webhook installation on IONOS Managed Kubernetes for automatic installation and update of TLS certificates for IONOS Core domains via the free "Let's Encrypt" ACME service. 
...
6. I would also recommend installation of kubectx and kubens on your management host as some of the scripts reference the kubectx executable.
...
This component utilises the opensource IONOS Webhook for Core DNS and Let's Encrypt originally written by fabmade.de.  I have compiled this and stored the built container image in my public DockerHub repository.
